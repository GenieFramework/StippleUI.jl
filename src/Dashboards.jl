...
function dashboard(elemid::Union{AbstractString,Symbol}, content::Union{String,Vector}; partial::Bool = true, title::String = "Stipple Dashboard", head_content::String = "",
